<?php
        ...
        if ($starterId !== '' && $starterId !== 'blank') {
            $starterBlocks = blocks_from_starter($starterId);
            if (!empty($starterBlocks)) {
                $newPage['content_blocks'] = $starterBlocks;
            }
        }
