...
<table>
    ...
    <tr><td><strong>Registrar</strong></td><td>5 wired</td><td>NameSilo, Namecheap, Porkbun, Dynadot, Cloudflare Registrar. Availability + NS switching on the first four; <strong>only NameSilo can complete a purchase today</strong> — Namecheap and Dynadot are API-capable but their adapters come with the buying step, and Porkbun and Cloudflare have no registration endpoint at all, so those are dashboard purchases recorded with <em>Mark as owned</em>. Managed from the console's Registrars tab.</td></tr>
