...
<section id="ms-specs">
    ...
    <div class="callout" style="border-left:4px solid #16a34a;"><strong>At a glance (updated 2026-07-04):</strong> Phase 1 ✅ complete · Phase 2 ◑ <strong>3 of 6</strong> (1e, 1d, 5c) · Phase 3 ◑ <strong>2 of 5</strong> (4c, 2d). Full multisite output verified <strong>byte-reproducible</strong> across reruns. <strong>Recommended next:</strong> <a href="#spec-theme-colors">4d</a> per-site theme colors (~½ d, cheapest code win, pairs with 4c) or <a href="#spec-finish-authoring">1f</a> finish master authoring (strategic, broader payoff, mostly authoring).</div>
    ...
    <div class="block-card-doc" id="spec-finish-authoring">
        <h3>1f · Finish master authoring <span class="pri should">Should</span> <span class="where preauthor" style="float:none;margin-left:6px;">Pre-authoring</span></h3>
        <p class="bc-meta">◑ reframed — this is authoring QA, now enforced by a validator (not a differentiation feature)</p>
