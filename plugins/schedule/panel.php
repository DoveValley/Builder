...
$courses    = _schedule_load_courses();
$editCourse = null;
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #e2e8f0;">
                        ...
                        <td style="padding:8px 12px;white-space:nowrap;">
                            ...
                            <form method="post" action="plugin_save.php" style="display:inline;" onsubmit="return confirm('Delete this course?');">
                                <input type="hidden" name="csrf_token" value="<?= h($csrfToken) ?>">
                                <input type="hidden" name="plugin_id" value="schedule">
                            ...
                            <form method="post" action="plugin_save.php" style="display:inline;">
                                <input type="hidden" name="csrf_token" value="<?= h($csrfToken) ?>">
                                <input type="hidden" name="plugin_id" value="schedule">
